...
public class series {
    ...
    public void displayS(){
        ...
        for(j=0;j<i;j++) {
            ...
            System.out.format("%5s %30s %20f %20f %10s",
                    p, series[j],consumptionHour[j],consumptionDay[j],tempRating[j]);
            System.out.println();    }
    }
    public void show(int p){
        ...
        System.out.format("%30s %15s %15s %18f %18f %6s",
                series[id],startDate[id],endDate[id],consumptionHour[id],consumptionDay[id],tempRating[id]);
        System.out.println();
    }
}
